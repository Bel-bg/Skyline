...
const translations = {
  en: {
    ...
    // Hero
    'hero.title': 'Saveur Moderne',
    'hero.subtitle': 'Where Tradition Meets Innovation',
    'hero.description': 'Experience the perfect harmony of traditional French cuisine and modern culinary artistry in an elegant atmosphere.',
    ...
    'about.description': 'At Saveur Moderne, we believe that the best cuisine comes from respecting tradition while embracing innovation. Our chefs combine time-honored French techniques with contemporary flavors and presentations.',
  ...
  fr: {
    ...
    'hero.description': 'Découvrez l\'harmonie parfaite entre la cuisine française traditionnelle et l\'art culinaire moderne dans une atmosphère élégante.',
    ...
    'about.description': 'Chez Saveur Moderne, nous croyons que la meilleure cuisine vient du respect de la tradition tout en embrassant l\'innovation. Nos chefs combinent les techniques françaises ancestrales avec des saveurs et présentations contemporaines.',
