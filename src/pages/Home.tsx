  ...
  const features = [
    {
      ...
      description:
        "Nos chefs allient tradition française et innovation moderne",
    },
    {
      icon: <Clock className="w-8 h-8" />,
      title: "Service Impeccable",
      description:
        "Une expérience culinaire mémorable dans une atmosphère raffinée",
    },
    {
      icon: <Utensils className="w-8 h-8" />,
      title: "Ingrédients Premium",
      description:
        "Sélection rigoureuse des meilleurs produits locaux et de saison",
    },
  ];
  ...
  const reviews = [
    {
      ...
      rating: 5,
      comment:
        "Une expérience gastronomique exceptionnelle ! Le mélange tradition-modernité est parfait.",
      date: "Il y a 2 jours",
    },
    {
      ...
      rating: 5,
      comment:
        "Service irréprochable et cuisine d'une finesse remarquable. Je recommande vivement !",
    ...
    },
    {
      ...
      rating: 4,
      comment:
        "Cadre magnifique et plats délicieux. Une belle découverte dans Paris.",
    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          <p
            className="text-xl md:text-2xl text-elegant mb-4 animate-fade-in-up"
            style={{ animationDelay: "0.2s" }}
          >
            {t("hero.subtitle")}
          </p>
          <p
            className="text-lg text-elegant mb-8 max-w-2xl mx-auto animate-fade-in-up"
          ...
          >
            <Button
              asChild
              size="lg"
              className="gradient-primary hover:shadow-glow transition-spring text-lg px-8"
            >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground text-elegant max-w-2xl mx-auto">
              Découvrez notre approche unique qui marie l'excellence de la
              tradition française avec l'audace de la cuisine moderne.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="text-center shadow-card hover:shadow-elegant transition-spring gradient-card border-border/50"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-muted-foreground text-elegant">
                Années d'Excellence
              </div>
            </div>
            {/* <div>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-elegant mb-8 max-w-2xl mx-auto opacity-90">
            Vivez une expérience gastronomique inoubliable dans notre restaurant
            tradi-moderne
          </p>
